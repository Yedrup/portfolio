            ...
            <Layout>
              ...
              <div className="c-resume-scrollable">
                ...
                <Element name="sectionJob">
                  <h2 id="js-sectionJob" className="c-page__section__title">
                    {jobsSection.title}
                  </h2>
                  <ul className="c-jobs">
                ...
                <Element name="sectionSkills">
                  <h2 id="js-sectionSkills" className="c-page__section__title">
                    {skillsSection.title}
                  </h2>
                ...
                <Element name="sectionEducation">
                  <h2
                    id="js-sectionEducation"
                    className="c-page__section__title"
                  >
